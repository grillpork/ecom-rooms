    ...
    <main className="w-full">
      <section className="max-w-7xl mx-auto m-24">
        <div className="grid grid-cols-3">
          ...
          <section data-aos="fade-left" className="space-y-4">
            ...
            <button data-aos="fade-left" data-aos-delay="200"  className="flex gap-4 items-center px-4 py-2 rounded-full bg-gray-700 cursor-pointer ">
      ...
      <section id="room" className="w-full py-12 px-24 mx-auto">
      ...
      <section  id="preview" className="p-18">
         <div className="grid place-content-center p-12 grid-cols-2 gap-12 bg-no-repeat bg-cover bg-center bg-fixed " style={{backgroundImage: "linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.8)), url(/workingRoom_1.jpg)"}}>
                <section className="grid place-content-center gap-12">
                    <p data-aos="fade-up" data-aos-delay="100" className="text-yellow-500">PROMO VIDEO</p>
                    <h1 data-aos="fade-up" data-aos-delay="200" className=" text-6xl font-semibold ">Ensuring safe experience from design to installation</h1>
                    <p data-aos="fade-up" data-aos-delay="300" className="w-132">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Harum in magni suscipit dicta fugiat placeat vero officiis, quasi perspiciatis mollitia.</p>
                    <button data-aos="fade-up" data-aos-delay="400" className=" flex items-center gap-4 px-8 py-4 cursor-pointer bg-gray-800 w-fit rounded-full">MOORE VIDEO <CiPlay1/></button>
                </section>
